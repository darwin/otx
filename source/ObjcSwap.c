...
swap_objc_method(
	objc_method*	method)
{
	method->method_name		= (SEL)OSSwapInt32((long)method->method_name);
	method->method_types	= (char*)OSSwapInt32((long)method->method_types);
	method->method_imp		= (IMP)OSSwapInt32((long)method->method_imp);
}
